...
from app.auth.schemas import UserRegister, UserLogin, AccessToken, MessageResponse, ChangePassword, ResetPasswordRequest
...
@router.post("/change_password", response_model=MessageResponse, status_code=status.HTTP_200_OK)
