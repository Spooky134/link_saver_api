...
from app.collection.entities import (
    CollectionEntity,
...
class CollectionService:
    ...
    async def create_collection(
        self, user_id: int, collection_entity: CreateCollectionEntity
    ) -> CollectionEntity:
    ...
    async def list_links(
        ...
        links = await self.link_repo.list_by_collection(
            user_id, collection_id, skip, limit
        )
    ...
    async def search_by_name(
        ...
        return await self.collection_repo.search_by_name(
            user_id, query_string, skip, limit
        )
