...
async def test_add_and_get_link(db_session: AsyncSession):
    ...
    create_link = CreateLinkEntity(
        ...
        title="Как работает JS: WebRTC и механизмы P2P-коммуникаций",
        description="[Советуем почитать] Другие 19 частей цикла Часть 1: "
                    "Обзор движка, механизмов времени выполнения, стека вызовов Часть 2: О "
                    "внутреннем устройстве V8 и оптимизации кода Часть 3: Управление памятью,...",
        image_url="https://habr.com/share/publication/416821/486907090313c5170a87085a56d6cdfc/",
